				  ...
				  struct device_attribute *attr, char *buf)
{
	...
	case NO_PANEL:
		ret = snprintf(buf, buflen, "no panel\n");
		break;
	case MDDI_PANEL:
		ret = snprintf(buf, buflen, "mddi panel\n");
		break;
	case EBI2_PANEL:
		ret = snprintf(buf, buflen, "ebi2 panel\n");
		break;
	case LCDC_PANEL:
		ret = snprintf(buf, buflen, "lcdc panel\n");
		break;
	case EXT_MDDI_PANEL:
		ret = snprintf(buf, buflen, "ext mddi panel\n");
		break;
	case TV_PANEL:
		ret = snprintf(buf, buflen, "tv panel\n");
		break;
	case HDMI_PANEL:
		ret = snprintf(buf, buflen, "hdmi panel\n");
		break;
	case LVDS_PANEL:
		ret = snprintf(buf, buflen, "lvds panel\n");
		break;
	case DTV_PANEL:
		ret = snprintf(buf, buflen, "dtv panel\n");
		break;
	case MIPI_VIDEO_PANEL:
		ret = snprintf(buf, buflen, "mipi dsi video panel\n");
		break;
	case MIPI_CMD_PANEL:
		ret = snprintf(buf, buflen, "mipi dsi cmd panel\n");
		break;
	case WRITEBACK_PANEL:
		ret = snprintf(buf, buflen, "writeback panel\n");
		break;
	default:
		ret = snprintf(buf, buflen, "unknown panel\n");
		break;
	}

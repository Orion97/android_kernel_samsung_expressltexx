...
static void set_default_result(struct factory_data *data)
{
	...
	memcpy(data->cmd_result, data->cmd, strnlen(data->cmd, 32));
	strlcat(data->cmd_result, &delim, 1);
}

static void set_cmd_result(struct factory_data *data, char *buff, int len)
{
	strlcat(data->cmd_result, buff, len);
}
...
static void not_support_cmd(void *device_data)
{
	...
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%s", "NA");
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
	data->cmd_state = NOT_APPLICABLE;
	pr_info("tsp factory: %s: \"%s(%d)\"\n", __func__,
				data->cmd_buff,	strnlen(data->cmd_buff, 512));
	return;
}
...
static void get_fw_ver_bin(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff),
		"%s", FW_KERNEL_VERSION);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_fw_ver_ic(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%s", FW_IC_VERSION);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_config_ver(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%s_%s_%s",
...
static void get_threshold(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%.3d", buf[0]);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_chip_vendor(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%s", TSP_VENDOR);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_chip_name(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%s", TSP_IC);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_x_num(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%d",
		ts_data->platform_data->tx_channel_no);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_y_num(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff),
		"%d", ts_data->platform_data->rx_channel_no);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void get_raw_cap(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff), "%d", buf);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
...
static void run_tx_to_gnd_read(void *device_data)
{
	...
	set_default_result(data);
	snprintf(data->cmd_buff, sizeof(data->cmd_buff),
		sizeof(data->cmd_buff), "%d,%d", min_value, max_value);
	set_cmd_result(data, data->cmd_buff, strnlen(data->cmd_buff, 512));
	data->cmd_state = OK;
	return;
}
						...
						const char *buf, size_t count)
{
	...
	cur = strnchr(buf, sizeof(buf), (int)delim);
	if (cur)
	...
	list_for_each_entry(tsp_cmd_ptr, &data->cmd_list_head, list) {
		if (!strncmp(buff, tsp_cmd_ptr->cmd_name, sizeof(buff))) {
			cmd_found = true;
			break;
		}
	}
	...
	if (!cmd_found) {
		list_for_each_entry(tsp_cmd_ptr, &data->cmd_list_head, list) {
		if (!strncmp("not_support_cmd",
			tsp_cmd_ptr->cmd_name, sizeof(tsp_cmd_ptr->cmd_name)))
				break;
		}
	}
				...
				struct device_attribute *attr, char *buf)
{
	...
	case WAITING:
		snprintf(buff, sizeof(buff), "%s", TOSTRING(WAITING));
		break;
	case RUNNING:
		snprintf(buff, sizeof(buff), "%s", TOSTRING(RUNNING));
		break;
	case OK:
		snprintf(buff, sizeof(buff), "%s", TOSTRING(OK));
		break;
	case FAIL:
		snprintf(buff, sizeof(buff), "%s", TOSTRING(FAIL));
		break;
	case NOT_APPLICABLE:
		snprintf(buff, sizeof(buff), "%s", TOSTRING(NOT_APPLICABLE));
		break;
	default:
		snprintf(buff, sizeof(buff), sizeof(buff),
			"%s", TOSTRING(NOT_APPLICABLE));
		break;
	}
				...
				struct device_attribute *attr, char *buf)
{
	...
	pr_info("tsp factory: tsp cmd: result: \"%s(%d)\"\n",
			data->cmd_result, strnlen(data->cmd_result, 512));

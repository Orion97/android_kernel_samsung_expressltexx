...
#define MSM_ION_QSECOM_SIZE	0x1400000 /* (7.5MB) */
...
void gpio_key_rev_init(void)
{
	if (system_rev > BOARD_REV00)
		gpio_keys_button[2].gpio = GPIO_HOME_KEY_REV01;
	else
		gpio_keys_button[2].gpio = GPIO_HOME_KEY_REV00;
}
...
static void __init msm8930_stunner_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif

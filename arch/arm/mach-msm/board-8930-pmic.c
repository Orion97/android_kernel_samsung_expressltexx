...
static struct pm8xxx_gpio_init pm8917_gpios[] __initdata = {
	...
	/* keys GPIOs */
#if defined(CONFIG_MACH_STUNNER)
	PM8917_GPIO_INPUT(2, PM_GPIO_PULL_UP_30),
#endif
};
...
#ifdef CONFIG_MACH_STUNNER
static unsigned int siop_ratio_table[] = {
	100,
	80,
	0
};
...
static struct pm8921_sec_battery_data pm8921_battery_pdata __devinitdata = {
	...
	.temp_high_block_event		= 640,
	.temp_high_recover_event		= 600,
	.temp_low_block_event			= -45,
	.temp_low_recover_event		= -10,
	/* temperature set (normal) */
	.temp_high_block_normal		= 540,
	.temp_high_recover_normal		= 452,
	.temp_low_block_normal		= -16,
	.temp_low_recover_normal		= 20,
	/* temperature set (lpm) */
	.temp_high_block_lpm			= 515,
	.temp_high_recover_lpm		= 495,
	.temp_low_block_lpm			= -45,
	.temp_low_recover_lpm			= -15,
#elif defined(CONFIG_MACH_GODIVA)
	/* temperature set (event) */
	.temp_high_block_event		= 700,
	.temp_high_recover_event		= 475,
	.temp_low_block_event			= -19,
	.temp_low_recover_event		= 31,
	/* temperature set (normal) */
	.temp_high_block_normal		= 563,
	.temp_high_recover_normal		= 475,
	.temp_low_block_normal		= -19,
	.temp_low_recover_normal		= 18,
	/* temperature set (lpm) */
	.temp_high_block_lpm			= 530,
	.temp_high_recover_lpm		= 440,
	.temp_low_block_lpm			= -65,
...
#if defined(CONFIG_MACH_STUNNER)
#define R_CONN	61
#define R_SENSE 11540
#elif defined(CONFIG_MACH_GODIVA)
#define R_CONN	70
#define R_SENSE 11540
#elif defined(CONFIG_MACH_EXPRESS)
#define R_CONN	111
#define R_SENSE 12320
#else
#define R_CONN	50
#define R_SENSE 11540
#endif

#if defined(CONFIG_MACH_STUNNER) || defined(CONFIG_MACH_GODIVA)

...
int gpio_rev(unsigned int index)
{
	...
	int cur_latest_device = BOARD_REV01;
...
#define MSM_ION_QSECOM_SIZE	0x1400000 /* (20MB) */
...
void wpc_hw_init(void)
{
	struct pm_gpio wpc_int_param = {
...
/* array index should be paired with enum cable_type_t in pm8921-charger.h */
static struct fsa9485_cb_struct fsa9485_cb[] = {
	{ "none", SUPPORTED },
	{ "usb", SUPPORTED },
	{ "ac",  SUPPORTED },
	{ "misc", SUPPORTED },
	...
	{ "unknown", SUPPORTED },
	{ "cdp", SUPPORTED },
	{ "smart_dock", SUPPORTED },
	{ "otg", SUPPORTED },
	{ "audio dock", SUPPORTED},
...
static void fsa9485_callback(enum cable_type_t cable_type, int attached)
{
	...
	if (!fsa9485_cb[cable_type].is_support)
		return;
	pr_info("fsa9485_%s_cb attached %d\n", fsa9485_cb[cable_type].name,
			attached);
...
static struct i2c_gpio_platform_data geo_i2c_gpio_data = {
	.sda_pin = GPIO_SENSOR_GEO_SDA,
	.scl_pin = GPIO_SENSOR_GEO_SCL,
	.udelay = 5,
};

static struct platform_device geo_i2c_gpio_device = {
	.name = "i2c-gpio",
	.id = MSM_GEO_I2C_BUS_ID,
	.dev = {
		.platform_data = &geo_i2c_gpio_data,
	},
};

static void mag_init_gpio()
{
	gpio_tlmm_config(GPIO_CFG(GPIO_SENSOR_GEO_SDA, 0, GPIO_CFG_INPUT,
		GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 1);
	gpio_tlmm_config(GPIO_CFG(GPIO_SENSOR_GEO_SCL, 0, GPIO_CFG_INPUT,
		GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 1);
}

static struct mag_platform_data magnetic_pdata = {
	.position = 1,
	.init_gpio = mag_init_gpio,
};
...
/*
	...
	gp2a020_data.d0_value[D0_COND1_A] = 785;
	gp2a020_data.d0_value[D0_COND2] = 62;
	gp2a020_data.d0_value[D0_COND2_A] = 2003;
	gp2a020_data.d0_value[D0_COND2_B] = 2970;
	gp2a020_data.d0_value[D0_COND3_A] = 506;
	gp2a020_data.d0_value[D0_COND3_B] = 556;
*/
}
...
#endif
		.irq = MSM_GPIO_TO_INT(GPIO_MHL_WAKE_UP),
	},
};
...
/*TODO: will fix
	...
	gpio_set_value(PMIC_GPIO_EAR_MICBIAS_EN, 1);
*/
...
{
	return (gpio_get_value_cansleep(GPIO_SHORT_SENDEND)) ^ 1;
...
static int sec_jack_get_ear_adc_value(void)
{
	int rc = 0;
	int retVal = 0;
...
#ifdef CONFIG_SAMSUNG_JACK_ADC_SCALE3
	.get_ear_adc_value		= sec_jack_get_ear_adc_value,
#endif
...
static void __init msm8930_godiva_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
...
*/
	...
	input_tkeyled_device_init();
#endif
#if defined(CONFIG_BATTERY_SAMSUNG)
	msm8930_init_battery();
#endif

#ifdef CONFIG_USB_HOST_NOTIFY
	if (system_rev < BOARD_REV05)
		msm_otg_power_init(47);
	else
		msm_otg_power_init(GPIO_OTG_TEST);
#endif
}

MACHINE_START(GODIVA, "SAMSUNG GODIVA")
	.map_io = msm8930_map_io,
	.reserve = msm8930_reserve,
	.init_irq = msm8930_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = msm8930_godiva_init,
